        ...
        <img src="/sitemap-snippet.png" alt="sitemap.ts file" className="mx-auto mt-4" />
          <div>
            ...
            <p className="text-lg">
              ...
              <p>The function's return type, MetadataRoute.Sitemap, ensures the structure matches what Next.js expects for generating a sitemap.xml file. This allows your sitemap to be generated dynamically and always up to date.
            </p>
        </div>
